...
/**
 * Configures the {@link CloudPoolProxy} subsystem over the
 * {@link AutoScalerFactoryRestApi} REST API.
 */
public class TestConfigureCloudPoolProxyOverRestApi extends AbstractAutoScalerCoreRestTest {
    ...
    public void configure() {
        // configure
        JsonObject config = parseJsonResource("cloudPool/cloudPool-config.json");
    ...
    public void reconfigure() {
        ...
        // reconfigure
        JsonObject newConfig = parseJsonResource("cloudPool/cloudPool-config2.json");
    ...
    public void configureWithInvalidConfig() {
        JsonObject config = parseJsonResource("cloudPool/cloudPool-config-invalid.json");
        Response response = postConfig(this.autoScaler.getId(), config);
