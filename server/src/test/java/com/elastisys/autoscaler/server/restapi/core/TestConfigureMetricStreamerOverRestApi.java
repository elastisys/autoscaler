...
/**
 * Configures the {@link MetricStreamer} subsystem over the
 * {@link AutoScalerFactoryRestApi} REST API.
 */
public class TestConfigureMetricStreamerOverRestApi extends AbstractAutoScalerCoreRestTest {
    ...
    public void configure() {
        // configure
        JsonObject config = parseJsonResource("metricStreamer/metricStreamer-config.json");
    ...
    public void reconfigure() {
        ...
        // reconfigure
        JsonObject newConfig = parseJsonResource("metricStreamer/metricStreamer-config2.json");
    ...
    public void configureWithInvalidConfig() {
        JsonObject config = parseJsonResource("metricStreamer/metricStreamer-config-invalid.json");
        Response response = postConfig(this.autoScaler.getId(), config);
